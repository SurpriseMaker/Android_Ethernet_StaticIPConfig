...
public final class Settings {
    ...
    public static final class Global extends NameValueTable {
        ...
        */
        ...
        /**
         *  RJ45 static IP parameters settings.
         *
         * @hide
         */
        public static final String RJ45_STATIC_IP = "rj45_static_ip";
        public static final String RJ45_STATIC_NETMASK = "rj45_static_netmask";
        public static final String RJ45_STATIC_GATEWAY = "rj45_static_gateway";
        public static final String RJ45_STATIC_DNS1 = "rj45_static_dns1";
        public static final String RJ45_STATIC_DNS2 = "rj45_static_dns2";

         /**
         *  USB card static IP parameters settings.
         *
         * @hide
         */
        public static final String USB_CARD_STATIC_IP = "usb_card_static_ip";
        public static final String USB_CARD_STATIC_NETMASK = "usb_card_static_netmask";
        public static final String USB_CARD_STATIC_GATEWAY = "usb_card_static_gateway";
        public static final String USB_CARD_STATIC_DNS1 = "usb_card_static_dns1";
        public static final String USB_CARD_STATIC_DNS2 = "usb_card_static_dns2";
        
        /**
         *
         * @hide
         */
        public static final String ETHERNET_IFACE_TYPE = "ethernet_iface_type";
        /** @hide */ public static final String INTERFACE_ETH0 = "eth0";
        /** @hide */ public static final String INTERFACE_ETH1 = "eth1";

        /**
         *
         * @hide
         */
        public static final String ETHERNET_IP_TYPE_ETH0 = "ethernet_ip_type_eth0";
        public static final String ETHERNET_IP_TYPE_ETH1 = "ethernet_ip_type_eth1";
        /** @hide */ public static final String TYPE_DHCP = "dhcp";
        /** @hide */ public static final String TYPE_STATIC = "static";
