...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //Set default show battery percent
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
	    ...
	    loadStringSetting(stmt, Settings.Global.NTP_SERVER_2,
            ...
            loadStringSetting(stmt, Settings.Global.RJ45_STATIC_IP,
                    R.string.def_rj45_static_ip);
            loadStringSetting(stmt, Settings.Global.RJ45_STATIC_NETMASK,
                    R.string.def_rj45_static_netmask);
            loadStringSetting(stmt, Settings.Global.RJ45_STATIC_GATEWAY,
                    R.string.def_rj45_static_gateway);
            loadStringSetting(stmt, Settings.Global.RJ45_STATIC_DNS1,
                    R.string.def_rj45_static_dns1);
            loadStringSetting(stmt, Settings.Global.RJ45_STATIC_DNS2,
                    R.string.def_rj45_static_dns2);

            loadStringSetting(stmt, Settings.Global.USB_CARD_STATIC_IP,
                    R.string.def_usb_card_static_ip);
            loadStringSetting(stmt, Settings.Global.USB_CARD_STATIC_NETMASK,
                    R.string.def_usb_card_static_netmask);
            loadStringSetting(stmt, Settings.Global.USB_CARD_STATIC_GATEWAY,
                    R.string.def_usb_card_static_gateway);
            loadStringSetting(stmt, Settings.Global.USB_CARD_STATIC_DNS1,
                    R.string.def_usb_card_static_dns1);
            loadStringSetting(stmt, Settings.Global.USB_CARD_STATIC_DNS2,
                    R.string.def_usb_card_static_dns2);
            
            loadStringSetting(stmt, Settings.Global.ETHERNET_IFACE_TYPE,
                    R.string.def_ethernet_iface_type);
            loadStringSetting(stmt, Settings.Global.ETHERNET_IP_TYPE_ETH0,
                    R.string.def_ethernet_ip_type);
            loadStringSetting(stmt, Settings.Global.ETHERNET_IP_TYPE_ETH1,
                    R.string.def_ethernet_ip_type);
